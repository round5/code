...
/**
 * @file
 * Speed tests for the Round5 tiny implementation.
 */
...
#ifdef USE_AES_DRBG
#ifdef AVX2
#define VER_TXT "AES AVX2 ----"
#elif defined(CM_CACHE)
#define VER_TXT "AES CM_CACHE "
#else
#define VER_TXT "AES ---------"
#endif
#else
...
#define VER_TXT "AVX2 --------"
#elif defined(CM_CACHE)
#define VER_TXT "CM_CACHE ----"
#else
#define VER_TXT "-------------"
#endif
#endif
    printf("----- Configuration %s T%d %s%.*s\n\n", CRYPTO_ALGNAME, ROUND5_API_TAU, VER_TXT, (int) (80 - 37 - strlen(CRYPTO_ALGNAME)), "---------------------------------------------");
